...
<html>
    ...
    <body>
        ...
        <div id="content" class="content">
            ...
            <h1>This is the default scheme for a webpage with the FAU FabLab design</h1>
            <p>Use a scheme like <a href="scheme.php" download>this</a>, to apply the style to your page.</p>
            <h2>Features</h2>
            <ul>
